...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geodemo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12236&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geodemo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geodemo` can be installed with:

```
conda install geodemo
```

It is possible to list all of the versions of `geodemo` available on your platform with:
